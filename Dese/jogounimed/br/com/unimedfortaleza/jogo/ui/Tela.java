...
public class Tela extends JFrame implements PropertyChangeListener
{
    ...
    public Tela() {
        ...
        (this.dialog = new JDialog(this, "Jogo Unimed Fortaleza", true)).setContentPane(this.optionPane);
    ...
    public Tela(final GameStartListener gameStartListener) {
        this();
        this.gameStartListener = gameStartListener;
    }
    
    public void setGameStartListener(final GameStartListener gameStartListener) {
        this.gameStartListener = gameStartListener;
    }
    ...
    public void propertyChange(final PropertyChangeEvent e) {
        ...
        if (this.dialog.isVisible() && e.getSource() == this.optionPane && ("value".equals(prop) || "inputValue".equals(prop))) {
            ...
            if (this.gameStartListener != null && intValue != null && intValue == 0) {
                this.gameStartListener.startGame();
            }
        }
    }
}
